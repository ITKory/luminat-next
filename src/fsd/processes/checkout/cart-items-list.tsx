...
const cartItems = [
  { id: "1", name: "Blur", description: "It is a long established fact that a reader will be distracted by the readable", price: 12000, quantity: 1, image: "/images/Blurglass.webp" },
  { id: "2", name: "Fossil", description: "It is a long established fact that a reader will be distracted by the readable", price: 12000, quantity: 1, image: "/images/Fossil.webp" },
  { id: "3", name: "Dot", description: "It is a long established fact that a reader will be distracted by the readable", price: 12000, quantity: 1, image: "/images/Dot.webp" },
]
...
export function CartItemsList() {
  return (
    <div className="df column-dir gap-32">
      <h5 className="text-green">Список покупок</h5>
      <div className="df column-dir gap-32">
        {cartItems.map((item) => (
