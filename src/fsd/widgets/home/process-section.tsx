const steps = [
    ...
    },
    {
        ...
        className: "w-100 df column-dir jcsb relative bg-image-block p-32 overflow-hidden",
    },
    {
        number: "#03",
                    ...
                    <div className="col-6 df">
                        {steps.slice(0, 2).map((step) => (
                            <div key={step.number} className={step.className}>
                                ...
                                <p className="relative z-10">{step.number}</p>
                                <div className="desc df column-dir gap-24 relative z-10">
                                    <h6>{step.title}</h6>
